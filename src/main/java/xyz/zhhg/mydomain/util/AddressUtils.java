...
public class AddressUtils {
     ...
     */
    public static final String getInnetIp() throws SocketException {
     ...
     * @return
     */
    public static final String getV4IP() {
        String ip = "";
     ...
     */
    public static final String getAddresses(String content, String encoding) throws UnsupportedEncodingException {
        //设置访问地址
     ...
     * @return
     */
    private static final String getResult(String urlStr, String content, String encoding) {
        URL url = null;
